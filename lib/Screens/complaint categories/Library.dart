...
class _LibraryState extends State<Library> {
  int _currentIndex = 0;
  final List<String> _carouselItems = ['Library related Complaint include Complaints about Unavailability of books in the library'];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            ...
                            onPressed: () {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>Library_Complaint(),
                              ));

                              print('Button pressed ...');
                              final snackbar =SnackBar(content: Text("You are viewing all Library Related Complaints!"),elevation: 20,backgroundColor: Colors.blue,
                            ...
                            text: 'View All Library Related Complaints',
