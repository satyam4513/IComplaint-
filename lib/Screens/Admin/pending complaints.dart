...
class pending_complaint extends StatefulWidget {
  const pending_complaint({Key? key}) : super(key: key);
  @override
  pending_complaintState createState() => pending_complaintState();
}

class pending_complaintState extends State<pending_complaint> {
  //////
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    await FirebaseFirestore.instance.collection('Complaint_data1').where('status',isEqualTo: 'Pending').get();
