...
class resolved_complaint extends StatefulWidget {
  const resolved_complaint({Key? key}) : super(key: key);
  @override
  resolved_complaintState createState() => resolved_complaintState();
}

class resolved_complaintState extends State<resolved_complaint> {
  //////
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    await FirebaseFirestore.instance.collection('Complaint_data1').where('status',isEqualTo: 'Complaint Resolved').get();
