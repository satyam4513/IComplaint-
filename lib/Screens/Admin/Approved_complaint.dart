...
class approved_complaint extends StatefulWidget {
  const approved_complaint({Key? key}) : super(key: key);
  @override
  approved_complaintState createState() => approved_complaintState();
}

class approved_complaintState extends State<approved_complaint> {
  //////
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    await FirebaseFirestore.instance.collection('Complaint_data1').where('status',isEqualTo: 'Complaint Approved').get();
              ...
              child: Stack(
                children: [
                  ...
                  const Positioned(
                      top: 55,
                      left: 20,
                      child: Text(" Approved Complaints",
                          style: TextStyle(
                              fontSize: 25,
