...
class Exam_complaint_admin extends StatefulWidget {
  const Exam_complaint_admin({Key? key}) : super(key: key);
  @override
  Exam_complaint_adminState createState() => Exam_complaint_adminState();
}

class Exam_complaint_adminState extends State<Exam_complaint_admin> {
  //////
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    await FirebaseFirestore.instance.collection('Complaint_data1').where('Complaint_type',isEqualTo: 'exam related').get();
