...
class document_admin extends StatefulWidget {
  @override
  _document_adminState createState() => _document_adminState();
}

class _document_adminState extends State<document_admin> {
  int _currentIndex = 0;
