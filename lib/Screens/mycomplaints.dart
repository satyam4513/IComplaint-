...
class my_complaints extends StatefulWidget {
  const my_complaints({Key? key}) : super(key: key);
  @override
  my_complaintsState createState() => my_complaintsState();
}

class my_complaintsState extends State<my_complaints> {
  //////
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    await FirebaseFirestore.instance.collection('Complaint_data1').where('uid',isEqualTo: FirebaseAuth.instance.currentUser!.uid).get();
                                            ...
                                            child: FFButtonWidget(
                                              ...
                                              onPressed: () {
                                                ...
                                                showDialog(
                                                  ...
                                                  builder: (BuildContext context) {
                                                    return AlertDialog(
                                                      title: Text("Complaint Deleted Successfully!"
                                                        ,style: TextStyle(color:Colors.green),),
                                                      content: Row(
                                                        children: [
                                                          Text(" On "+ DateTime.now().toString().substring(0,11),style: TextStyle(fontWeight: FontWeight.bold),),
                                                ...
                                                print('Button pressed ...');
                                                final snackbar =SnackBar(content: Text("Complaint Deleted Successfully!"),elevation: 20,backgroundColor: Colors.blue,
                                                  action: SnackBarAction(textColor: Colors.white, label: '', onPressed: () {
